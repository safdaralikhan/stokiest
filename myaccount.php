    ...
    <div class="bgc my-account-header page-title normal-title">
        ...
        <div class="  page-title-inner flex-row  container">
            <div class="flex-col flex-grow medium-text-center">
                ...
                <small class="uppercase">DASHBOARD</small>
            </div><!-- .flex-left -->
        </div><!-- flex-row -->
    </div>
      ...
      <?php include "SidebarDash1.php";?>
        ...
        <div id="content">
            ...
            <div class="container text">
                <p class="text" >Hello <strong>safdar khan</strong> (not <strong>safdar khan</strong>? <a
                        href="https://www.stockiest91.com/my-account/customer-logout/?_wpnonce=201a26a1ab"><b>Log out</b> </a>)
                </p>
                <p class="text">From your account dashboard you can view your <a
                        href="https://www.stockiest91.com/my-account/orders/">recent orders</a>, <b>manage your</b>  <a
                        href="https://www.stockiest91.com/my-account/edit-address/"><b> shipping and billing addresses </b></a>,
